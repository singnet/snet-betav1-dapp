    ...
    renderForm() {
        ...
        return (
            <React.Fragment>
                ...
                <div className="row">
                    <div className="col-md-3 col-lg-3"
                         style={{padding: "10px", fontSize: "13px", marginLeft: "10px"}}>Sample Sentences
                    </div>
                </div>
                <div className="col-md-3 col-lg-3">
                ...
                <div className="form-group">
                    ...
                    <textarea value={this.state.sentence} onChange={this.handleInputUpdate}
                ...
                <div className="row" align=" center">
                    <button type=" button" className=" btn btn-primary" disabled={!this.canBeInvoked()}
                            onClick={this.submitAction}>Call Co-reference Resolution Service
                    </button>
                </div>
            </React.Fragment>
        )
            ...
            <div style={{borderWidth: 2, borderColor: "#000000", boarderSytle: "solid"}}>
                ...
                <p>
                    {response['words']['word'].map((word, index) => (
                        <span style={{fontSize: '14px', color: colorForm[index]}} key={index}>{word} </span>
                    ))}
                </p>
            </div>
