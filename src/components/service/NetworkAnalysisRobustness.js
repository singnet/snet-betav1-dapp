...
export default class NetworkAnalysisRobustness extends React.Component {
    ...
    handleFormUpdate(event) {
        ...
        if (event.target.name === 'methodName' && this.state.inputFormType === InputView.Text) {
            ...
            default_val.value = event.target.value === 'MinNodesToRemove' ?
        ...
        if (this.state.methodName === 'MinNodesToRemove') {
            this.props.callApiCallback(this.state.serviceName,
                this.state.methodName, {
                    ...
                    source_node: this.state.dataset['source_node'],
                    target_node: this.state.dataset['target_node']
                });
        }
            ...
            <React.Fragment>
                            ...
                            <div className="form-group">
                                ...
                                <div align="center">
                                    <button type="button" className="btn btn-primary"
                                            onClick={this.handleValidateRequest}>Format/Validate Graph
                                    </button>
                                    <button type="button" className="btn btn-primary"
                ...
                <div className="row" align=" center">
                    <button type=" button" className="btn btn-primary" disabled={!this.canBeInvoked()}
                            onClick={this.submitAction}>Call Network Robustness Analysis
                    </button>
                </div>
            </React.Fragment>
        )
