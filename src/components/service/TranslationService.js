    ...
    renderForm() {
        ...
        return (
            <React.Fragment>
                ...
                <div className="row">
                    <div className="col-md-3 col-lg-3" style={{padding: "10px", fontSize: "13px", marginLeft: "10px"}}>Text to translate: </div>
                    <div className="col-md-3 col-lg-3">
                        <textarea rows="5" cols="60" name="text"
                               value={this.state.text} onChange={this.handleFormUpdate}/>
                    </div>
                </div>
                <div className="row">
